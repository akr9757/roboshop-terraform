    ...
    "Statement": [
      {
        ...
        "Resource": [
          "arn:aws:ssm:us-east-1:597067333039:parameter/${var.env}.${var.component_name}.*",
          "arn:aws:kms:us-east-1:*:key/arn:aws:kms:us-east-1:597067333039:key/7324a4aa-43b2-47be-98cf-a76f8acbc746"
        ]
      }
    ]
  })
